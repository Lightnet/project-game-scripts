...
function parseBuffer(socket, data,args){
    args.accumulatingLen = Buffer.byteLength(data);
    ...
    //console.log("args.accumulatingLen");
    //console.log(args.accumulatingLen);
}
...
function onClientConnected(socket) {
  ...
  var args = {};
  args.accumulatingBuffer = new Buffer(1024);
  ...
  socket.on('data', function (data) {
      console.log("Data");
      let reader = SmartBuffer.fromBuffer(data);
      let first = reader.readInt32LE();
      let second = reader.readInt32LE();
      console.log(first);
      console.log(second);

      //let reader = SmartBuffer.fromBuffer(data.toString('hex'));
      //let reader = SmartBuffer.fromBuffer(data);
      //let packetType = reader.readUInt16LE();
      //let packetLength = reader.readUInt16LE();
      //let text = reader.readStringNT();
      //let text = reader.readInt32LE();
      //console.log("DATA:"+text);
      //console.log(data.toString('utf8'));
      var buff = new Buffer(data);
      console.log(buff.toString('ascii'));
      //console.log(buff.toString('ascii',0,3));

      //console.log(data.toString('utf8',0));
      console.log(data.toString('hex')); //works I think
      //console.log(data.toString());
      //console.log('received data length :' + data.length );
      parseBuffer(socket, data, args);
